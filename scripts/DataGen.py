...
def main():
    if len(sys.argv) != 6:
        print(f"Usage: {sys.argv[0]} <executable_path> <total_sessions> <games_per_session> <thread_count> <nodes>")
        print(f"Example: {sys.argv[0]} ./bin/Utils/Release/LeafUtils 10 4000 2 8000")
        sys.exit(1)
