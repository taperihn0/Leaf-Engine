...
UniversalChessInterface::Options UniversalChessInterface::_options = { 
        ...
        OptionTunableParam(SpinType<double>(RfpEvalWeight,                8.,  28.),    "RfpEvalWeight",                1.05),
        OptionTunableParam(SpinType<double>(RfpBetaWeight,                8.,  28),     "RfpBetaWeight",                1.05),
        ...
        OptionTunableParam(SpinType<double>(NullMargin,                   1.2,  28.),   "NullMargin",                   0.15),
        ...
        OptionTunableParam(SpinType<double>(NullDiffScale,                800.,1300.),  "NullDiffScale",                1.),
        ...
        OptionTunableParam(SpinType<double>(QuietCutNodeReduction,        0.5, 12.),    "QuietCutNodeReduction",        1.6),
        ...
        OptionTunableParam(SpinType<double>(QuietKillerMoveReduction,     5., 60.),     "QuietKillerMoveReduction",     1.5),
        ...
        OptionTunableParam(SpinType<double>(TablebaseWinScore,            30000., 31500.), "TablebaseWinScore",         0.03),
