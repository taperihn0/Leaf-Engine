...
UniversalChessInterface::Options UniversalChessInterface::_options = { 
		...
		OptionTunableParam(SpinType<double>(NullMatThreshold,			  300., 1600.), "NullMatThreshold",			0.08),
		OptionTunableParam(SpinType<double>(NullVerifyMatLimit,			  300., 1200.), "NullVerifyMatLimit",		0.12),
