...
UniversalChessInterface::Options UniversalChessInterface::_options = { 
		...
		OptionTunableParam(SpinType<double>(LmrDepth,     	     2.,   4.),     "LmrDepth", 			2.9),
		...
		OptionTunableParam(SpinType<double>(PawnCapturedScore  , 80.,  130.),   "PawnCapturedScore",    0.8),
		...
		OptionTunableParam(SpinType<double>(RookCapturedScore  , 450., 600.),   "RookCapturedScore",    0.8),
		OptionTunableParam(SpinType<double>(QueenCapturedScore , 850., 1020.),  "QueenCapturedScore",   0.8),
