...
UniversalChessInterface::Options UniversalChessInterface::_options = { 
		...
		OptionTunableParam(SpinType<double>(QProbeDepth,         -5.,  5.),     "QProbeDepth", 			1.),
		//OptionTunableParam(SpinType<double>(ContemptFactor,      0.,   50.),    "ContemptFactor", 1.),
		OptionTunableParam(SpinType<double>(NNEvalScale,         2.,   12.),    "NNEvalScale", 			1.),
		OptionTunableParam(SpinType<double>(ImprovingRate, 		 20,   100.),   "ImprovingRate" , 	  	1.),
		OptionTunableParam(SpinType<double>(RfpImprovingSink, 	 1,    7.),     "RfpImprovingSink",   	1.),
		OptionTunableParam(SpinType<double>(NullMargin, 		 10,   150.),   "NullMargin", 			1.1),
		OptionTunableParam(SpinType<double>(NullImprovingSink ,  1,    7.), 	"NullImprovingSink", 	1.),
