...
UniversalChessInterface::Options UniversalChessInterface::_options = { 
		...
		OptionTunableParam(SpinType<double>(TablebaseProbeDepth, 		  2., 16.), 	"TablebaseProbeDepth", 		 2.1),
		OptionTunableParam(SpinType<double>(TablebasePieceCountLimit, 	  2., 10.), 	"TablebasePieceCountLimit",  1.9),
		OptionTunableParam(SpinType<double>(TablebaseWinScore, 			  25000., 31500.), "TablebaseWinScore",      0.07),
		OptionTunableParam(SpinType<double>(TablebasePieceDiffMult, 	  10., 250.), 	"TablebasePieceDiffMult",    0.5),
		OptionTunableParam(SpinType<double>(TablebaseScoreScale, 		  8., 20.), 	"TablebaseScoreScale", 		 1.7),
