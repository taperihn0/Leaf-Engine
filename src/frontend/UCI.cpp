...
UniversalChessInterface::Options UniversalChessInterface::_options = { 
        ...
        OptionTunableParam(SpinType<double>(IidDepthDiv,                  8.,  16.),    "IidDepthDiv",                  2.),
        OptionTunableParam(SpinType<double>(RfpDepth,                     2.,  6.),     "RfpDepth",                     2.),
        OptionTunableParam(SpinType<double>(RazorDepth,                   1.,  4.),     "RazorDepth",                   2.),
