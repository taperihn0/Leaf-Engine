...
UniversalChessInterface::Options UniversalChessInterface::_options = { 
		...
		OptionClearHash(),
		{ // --- Tunable parameters
		OptionTunableParam(SpinType<double>(MaxQuietsHistoryPow, 10.,  14.),    "MaxQuietsHistoryPow",  1.2),
		...
		OptionTunableParam(SpinType<double>(RfpDepth,     	     2.,   5.),     "RfpDepth", 		    2.8),
		OptionTunableParam(SpinType<double>(RazorDepth,          2.,   5.),     "RazorDepth", 		    2.8),
		OptionTunableParam(SpinType<double>(FutilityDepth,       2.,   5.),     "FutilityDepth", 	    2.8),
		OptionTunableParam(SpinType<double>(LmrDepth,     	     2.,   5.),     "LmrDepth", 			2.9),
		OptionTunableParam(SpinType<double>(NullReduction,       10.,  32.),    "NullReduction", 		1.3),
		OptionTunableParam(SpinType<double>(LmrMoveCount,        1.,   32.),    "LmrMoveCount", 		0.4),
		OptionTunableParam(SpinType<double>(RazorMultDelta,      5.,   100.),   "RazorMultDelta", 		0.43),
		OptionTunableParam(SpinType<double>(RfpMultDelta,        10.,  400.),   "RfpMultDelta", 		0.31),
		OptionTunableParam(SpinType<double>(FutilityMoveCount,   0.,   32.),    "FutilityMoveCount", 	0.45),
		OptionTunableParam(SpinType<double>(FutilityDelta,       2.,   216.),   "FutilityDelta", 		0.25),
		...
		OptionTunableParam(SpinType<double>(DynImprovementDepth, 3,    8.),     "DynImprovementDepth",  2.),
