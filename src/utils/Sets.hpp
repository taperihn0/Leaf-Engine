...
_INTERNAL const std::vector<std::string> CcrOneHourSets = {
	...
	"rnbq1rk1/pppp1ppp/4pn2/8/1bPP4/P1N5/1PQ1PPPP/R1B1KBNR b KQ - 1 5; bm Bxc3+;",
	...
	"rnbq1b1r/ppp2kpp/3p1n2/8/3PP3/8/PPP2PPP/RNBQKB1R b KQ d3 1 5; am Nxe4; ",
...
_INTERNAL const std::vector<std::string> NullMoveSets = {
