...
inline _P_CONSTEXPR int QuietMoveScoreReductionRate = roundi<float>(12.8824f);
inline _P_CONSTEXPR int QuietMoveScoreReductionDiv = roundi<float>(4.30811f);
inline _P_CONSTEXPR int CaptureMoveScoreReductionDiv = roundi<float>(73.4038f);
inline _P_CONSTEXPR int KnightCapturedScore = roundi<float>(293.29f);
inline _P_CONSTEXPR int BishopCapturedScore = roundi<float>(320.252f);
inline _P_CONSTEXPR int ToKnightPromoScore = roundi<float>(124.011f);
inline _P_CONSTEXPR int ToBishopPromoScore = roundi<float>(51.4321f);
inline _P_CONSTEXPR int ToRookPromoScore = roundi<float>(160.891f);
inline _P_CONSTEXPR int ToQueenPromoScore = roundi<float>(908.594f);
