...
inline _P_CONSTEXPR int FutilityDepth = roundi<float>(3.80804f);
inline _P_CONSTEXPR int LmrDepth = roundi<float>(1.87427f);
inline _P_CONSTEXPR int LmrBaseReduction = roundi<float>(28.f);
inline _P_CONSTEXPR int LmrLogDepthMovesMult = roundi<float>(12.f);
inline _P_CONSTEXPR int NullReduction = roundi<float>(35.4356f);
...
inline _P_CONSTEXPR int QMaterialDelta = roundi<float>(1106.39f);
inline _P_CONSTEXPR int QProbeDepth = roundi<float>(-0.0991618f);
inline _P_CONSTEXPR int NNEvalScale = roundi<float>(13.7321f);
inline _P_CONSTEXPR int ImprovingRate = roundi<float>(39.2507f);
inline _P_CONSTEXPR int RfpImprovingSink = roundi<float>(1.86056f);
inline _P_CONSTEXPR int NullMargin = roundi<float>(4.33824f);
inline _P_CONSTEXPR int NullImprovingSink = roundi<float>(9.12689f);
inline _P_CONSTEXPR int DynImprovementDepth = roundi<float>(9.15901f);
inline _P_CONSTEXPR int TTEvalCorrRate = roundi<float>(2.36075f);
inline _P_CONSTEXPR int NullDiffScale = roundi<float>(1053.47f);
inline _P_CONSTEXPR int NullDepth = roundi<float>(3.01463f);
inline _P_CONSTEXPR int NextDepthTimeRed = roundi<float>(6.82642f);
inline _P_CONSTEXPR int UnstableMatMargin = roundi<float>(13.8272f);
inline _P_CONSTEXPR int UnstableMultMargin = roundi<float>(6.80492f);
inline _P_CONSTEXPR int ContemptDiv = roundi<float>(86.5476f);
inline _P_CONSTEXPR int ImprovingExtensionRate = roundi<float>(6.64036f);
...
inline _P_CONSTEXPR int QuietKillerMoveReduction = roundi<float>(36.6035f);
inline _P_CONSTEXPR int QuietTotalReductionRate = roundi<float>(43.95f);
inline _P_CONSTEXPR int CaptureNotPvNodeReduction = roundi<float>(19.0004f);
inline _P_CONSTEXPR int CaptureCutNodeReduction = roundi<float>(12.3796f);
...
inline _P_CONSTEXPR int NullVerifyDepth = roundi<float>(9.12013f);
inline _P_CONSTEXPR int MoveCheckExtensionRate = roundi<float>(12.2576f);
inline _P_CONSTEXPR int MoveCheckExtensionDiv = roundi<float>(9.95162f);
inline _P_CONSTEXPR int ImprovingExtensionMateRate = roundi<float>(12.6104f);
inline _P_CONSTEXPR int MateThreadFracExtensionRate = roundi<float>(11.6797f);
inline _P_CONSTEXPR int MateThreadFracExtensionDiv = roundi<float>(17.9521f);
inline _P_CONSTEXPR int MaxMoveExtensionRate = roundi<float>(16.3261f);
inline _P_CONSTEXPR int MaxMoveExtensionDiv = roundi<float>(10.9455f);
inline _P_CONSTEXPR int NullVerifyDepthMult = roundi<float>(2.94352f);
inline _P_CONSTEXPR int ExtensionDepth = roundi<float>(16.8311f);
inline _P_CONSTEXPR int SingularDepth = roundi<float>(4.03396f);
inline _P_CONSTEXPR int SingularDepthMargin = roundi<float>(1.71455f);
inline _P_CONSTEXPR int SingularExtensionRate = roundi<float>(3.08547f);
inline _P_CONSTEXPR int SingularBetaDepthMult = roundi<float>(2.60718f);
inline _P_CONSTEXPR int SingularDepthMult = roundi<float>(124.551f);
inline _P_CONSTEXPR int SingularDepthBase = roundi<float>(535.727f);
inline _P_CONSTEXPR int SingularBetaExtensionRate = roundi<float>(8.8357f);
inline _P_CONSTEXPR int TablebaseProbeDepth = roundi<float>(7.33313f);
inline _P_CONSTEXPR int TablebasePieceCountLimit = roundi<float>(5.63201f);
inline _P_CONSTEXPR int TablebaseWinScore = roundi<float>(31036.8f);
inline _P_CONSTEXPR int TablebasePieceDiffMult = roundi<float>(105.374f);
inline _P_CONSTEXPR int TablebaseScoreScale = roundi<float>(17.0653f);
inline _P_CONSTEXPR int AspirationSearchDepth = roundi<float>(4.42753f);
inline _P_CONSTEXPR int AspirationFirstWindow = roundi<float>(68.2525f);
inline _P_CONSTEXPR int AspirationUnstableFactor = roundi<float>(179.176f);
inline _P_CONSTEXPR int AspirationDepthRate = roundi<float>(0.906031f);
inline _P_CONSTEXPR int AspirationMaxDepthInfl = roundi<float>(8.44154f);
inline _P_CONSTEXPR int AspirationWindowScoreDiv = roundi<float>(5208.23f);
inline _P_CONSTEXPR int AspirationMaxWindow = roundi<float>(736.662f);
inline _P_CONSTEXPR int AspirationCount = roundi<float>(3.4091f);
inline _P_CONSTEXPR int AspirationWidenRate = roundi<float>(4.68001f);
inline _P_CONSTEXPR int SeeValuePrune = roundi<float>(-8.86404f);
inline _P_CONSTEXPR int RfpQuietPenaltyMult = roundi<float>(19.f);
