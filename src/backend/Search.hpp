...
_PARAM_ATTRIBS int FutilityDepth = roundi<float>(1.80804f);
...
_PARAM_ATTRIBS int RfpEvalWeight = roundi<float>(16.f);
_PARAM_ATTRIBS int RfpBetaWeight = roundi<float>(16.f);
_PARAM_ATTRIBS int FutilityMoveCount = roundi<float>(6.8672f);
_PARAM_ATTRIBS int FutilityDelta = roundi<float>(28.8808f);
_PARAM_ATTRIBS int RazorBaseDelta = roundi<float>(119.431f);
_PARAM_ATTRIBS int QMaterialDelta = roundi<float>(1106.39f);
_PARAM_ATTRIBS int QProbeDepth = roundi<float>(-0.0991618f);
...
_PARAM_ATTRIBS int DynamicImprovementDepth = roundi<float>(9.15901f);
...
_PARAM_ATTRIBS int NullVerifyDepth = roundi<float>(9.12013f);
