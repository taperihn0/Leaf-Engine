...
inline _P_CONSTEXPR int	LmrMoveCount = 4;
...
inline _P_CONSTEXPR int NullVerifyDepth = 2;
inline _P_CONSTEXPR int MoveCheckExtensionRate = 16;
inline _P_CONSTEXPR int MoveCheckExtensionDiv = 16;
