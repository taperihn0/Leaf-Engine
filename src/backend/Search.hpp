...
inline _P_CONSTEXPR int	IidDepthDiv       = 12;
inline _P_CONSTEXPR int	RfpDepth          = 3;
inline _P_CONSTEXPR int RazorDepth        = 2;
inline _P_CONSTEXPR int	FutilityDepth     = 5;//4
inline _P_CONSTEXPR int	LmrDepth 	      = 2;
inline _P_CONSTEXPR int NullDiffScale	  = 1090; //1092
inline _P_CONSTEXPR int	NullReduction     = 28;//29
inline _P_CONSTEXPR int NullDepth		  = 4;
inline _P_CONSTEXPR int	LmrMoveCount      = 7;//6
inline _P_CONSTEXPR int RazorMultDelta    = 21;
inline _P_CONSTEXPR int RfpMultDelta      = 123;//131
inline _P_CONSTEXPR int FutilityDelta     = 15;//17
inline _P_CONSTEXPR int FutilityMoveCount = 7;
inline _P_CONSTEXPR int RazorBaseDelta    = 90;//81
inline _P_CONSTEXPR int QMaterialDelta    = 1030;//1004
inline _P_CONSTEXPR int QProbeDepth		  = -2;
inline _P_CONSTEXPR int NNEvalScale		  = 9;
inline _P_CONSTEXPR int ImprovingRate     = 62;//63
inline _P_CONSTEXPR int RfpImprovingSink  = 2;
inline _P_CONSTEXPR int NullMargin 		  = 10;//11
inline _P_CONSTEXPR int NullImprovingSink = 3;
inline _P_CONSTEXPR int DynImprovementDepth = 8;
inline _P_CONSTEXPR int TTEvalCorrRate	  = 3;
inline _P_CONSTEXPR int NextDepthTimeRed  = 6;
inline _P_CONSTEXPR int UnstableMatMargin = 42;//30
