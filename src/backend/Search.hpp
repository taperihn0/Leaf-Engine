...
inline _P_CONSTEXPR int	FutilityDepth     = 5;
...
inline _P_CONSTEXPR int RazorBaseDelta    = 90;
inline _P_CONSTEXPR int QMaterialDelta    = 1030;
inline _P_CONSTEXPR int QProbeDepth		  = -2;
inline _P_CONSTEXPR int NNEvalScale		  = 9;
inline _P_CONSTEXPR int ImprovingRate     = 62;
inline _P_CONSTEXPR int RfpImprovingSink  = 2;
inline _P_CONSTEXPR int NullMargin 		  = 10;
...
inline _P_CONSTEXPR int UnstableMatMargin = 42;
